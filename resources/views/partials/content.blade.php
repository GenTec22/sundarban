<main class="app-content">
    ...
    <div class="col-md-6 col-lg-3">
        <div class="widget-small primary coloured-icon">
            ...
            <a id="index" class="navbar-brand" href="{{url('/product')}}">
            <div class="info">
                <h4>Products</h4>
    ...
    <div class="col-md-6 col-lg-3">
        <div class="widget-small info coloured-icon">
            ...
            <a id="index" class="navbar-brand" href="{{url('/sales')}}">
            <div class="info">
                <h4>Sales</h4>
                <p><b>{{ $totalSales }}</b></p>
            </div>
    ...
    <div class="col-md-6 col-lg-3">
        <div class="widget-small warning coloured-icon">
            ...
            <a id="index" class="navbar-brand" href="{{url('/customer')}}">
            <div class="info">
                <h4>Customer</h4>
    ...
    <div class="col-md-6 col-lg-3">
        <div class="widget-small danger coloured-icon">
            ...
            <a id="index" class="navbar-brand" href="{{url('/invoice')}}">
            <div class="info">
                <h4>Invoices</h4>
